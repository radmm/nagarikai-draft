...
export default function BottomNav({ currentTab, setTab, unreadCount, language = "en" }: BottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex justify-between items-center px-4 py-2 w-[92%] max-w-md bg-[#000000]/60 backdrop-blur-2xl border border-white/10 rounded-full">
      {tabs.map((tab) => {
